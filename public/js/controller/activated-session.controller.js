...
angular.module('QASystem')
  .controller('activatedSessionCtrl', function ($scope, $http, $window) {
    ...
    //   }
    //   // get pager object from service
    //   $scope.pager = PagerService.GetPager($scope.listActivedEvents.length, page);
    //   // get current page of items
    //   $scope.items = $scope.listActivedEvents.slice($scope.pager.startIndex, $scope.pager.endIndex + 1);
    // }
